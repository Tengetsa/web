...
$works = [
    [
        ...
        "description" => "Монтраж и демонтаж, ремонт и обслуживание электрооборудования"
    ],
    [
        "name" => "Водитель",
        "dateStart" => "Февраль 2010",
        "dateEnd" => "Текущее время",
        "description" => "Транспортировка сотрудников компании"
    ],
    [
        "name" => "Убрщик",
        "dateStart" => "Июнь 2014",
        "dateEnd" => "Октябрь 2018",
        "description" => "Уборка закреплённого помещения"
    ]
